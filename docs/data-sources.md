...
| [OpenStreetMap Standard tiles](https://www.openstreetmap.org/copyright) | Context map outside 神田神保町1–3 | Displayed as a subdued raster below the opaque white map inside the study area; © OpenStreetMap contributors appears on the map. |
